...
funs = conformalInference::lasso.funs(nlambda=100,cv=TRUE,cv.rule="1se")
funs$train
funs$predict
funs$active

# Split-sample LOCO analysis
out.loco = conformalInference::loco(x, y, alpha=0.1, train.fun=funs$train, predict.fun=funs$predict,
